...
class PemateriKajianPage extends StatelessWidget {
  const PemateriKajianPage({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) =>
          UstadzBloc(UstadzService(), roleSlugs: ['pemateri_kajian'])
            ..add(FetchUstadzList()),
      child: const PemateriKajianView(),
    );
  }
}

class PemateriKajianView extends StatefulWidget {
  const PemateriKajianView({super.key});

  @override
  State<PemateriKajianView> createState() => _PemateriKajianViewState();
}

class _PemateriKajianViewState extends State<PemateriKajianView> {
                        ...
                        builder: (context, state) {
                          ...
                          if (state is UstadzListLoaded) {
                            if (state.filteredItems.isEmpty) {
                              return const Center(
                                child: Text('Tidak ada pemateri yang tercatat'),
                              );
                            }
