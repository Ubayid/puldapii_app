...
class KhatibPage extends StatelessWidget {
  const KhatibPage({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) =>
          UstadzBloc(UstadzService(), roleSlugs: ['khatib'])
            ..add(FetchUstadzList()),
      child: const KhatibView(),
    );
  }
}

class KhatibView extends StatefulWidget {
  const KhatibView({super.key});

  @override
  State<KhatibView> createState() => _KhatibViewState();
}

class _KhatibViewState extends State<KhatibView> {
                        ...
                        builder: (context, state) {
                          ...
                          if (state is UstadzListLoaded) {
                            if (state.filteredItems.isEmpty) {
                              return const Center(
                                child: Text('Tidak ada khatib yang tercatat'),
                              );
                            }
