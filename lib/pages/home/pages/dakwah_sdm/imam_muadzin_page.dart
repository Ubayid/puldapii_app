...
class ImamMuadzinPage extends StatelessWidget {
  const ImamMuadzinPage({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) =>
          UstadzBloc(UstadzService(), roleSlugs: ['imam', 'muadzin'])
            ..add(FetchUstadzList()),
      child: const ImamMuadzinView(),
    );
  }
}

class ImamMuadzinView extends StatefulWidget {
  const ImamMuadzinView({super.key});

  @override
  State<ImamMuadzinView> createState() => _ImamMuadzinViewState();
}

class _ImamMuadzinViewState extends State<ImamMuadzinView> {
                        ...
                        builder: (context, state) {
                          ...
                          if (state is UstadzListLoaded) {
                            if (state.filteredItems.isEmpty) {
                              return const Center(
                                child: Text(
                                  'Data imam / muadzin tidak ditemukan',
                                ),
                              );
                            }
